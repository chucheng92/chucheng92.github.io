...
function sskadmin(e) {
	var ssk = '';
	if(e.user_id==13430879){
		ssk = '<span class="sskadmin">站长'
	}
	return ssk+"</span> ";
}
//管理员判断结束
...
function ua(e) {
	...
	function os(e) {
		...
		if (e.match(/win/ig)) {
			...
			os = '<span class="os_unix"><i class="fa fa-linux"> Unix'
	...
	function() {
		...
		H.Replybox.prototype = {
			render: function(e) {
				...
				S = function(e, t) {
					var n = j('<h2>\u793e\u4ea4\u5e10\u53f7\u767b\u5f55</h2><div class="ds-icons-32">' + i.map(["weibo", "qq", "renren", "kaixin", "douban"],
					function(e) {
		...
		J.loginWidget = function() {
			...
			return i.each(["weibo", "qq", "renren", "kaixin", "douban"],
			function(t, n) {
